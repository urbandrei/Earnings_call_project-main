...
values; and the splits are guarded by leakage assertions in CI. Manifests written
for results that predate this mechanism are labelled \emph{backfill} until their
producing command is re-run. \pending{Clean-machine regeneration of
Table~\ref{tab:baselines} is recorded with the reproducibility package.}
